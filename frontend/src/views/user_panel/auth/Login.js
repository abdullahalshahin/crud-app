...
export class Login extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            localStorage.setItem('AUTH_USER', JSON.stringify(response_data.result.user));
            localStorage.setItem('AUTH_USER_TOKEN', response_data.token);
            localStorage.setItem('AUTH_USER_PERMISSIONS', JSON.stringify(response_data.result.permissions));
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-xxl-4 col-lg-5">
                                ...
                                <div className="row mt-3">
                                    <div className="col-12 text-center">
                                        <p className="text-danger">Don't have an account? <Link to={'/user-panel/dashboard/registration'} className="text-danger ms-1"><b>Sign Up</b></Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
